...
MAX_LOOKBACK_DAYS = _env_int("MAX_LOOKBACK_DAYS", 14)
LOOKBACK_STEP_DAYS = _env_int("LOOKBACK_STEP_DAYS", 2)
OVERWRITE_EXECUTION = _env_int("OVERWRITE_EXECUTION", 1)
...
TRENDS_VERBOSE = _env("TRENDS_VERBOSE", "1")
