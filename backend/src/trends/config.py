...
MAX_REFERENCE_LOOKUPS = _env_int("MAX_REFERENCE_LOOKUPS", 36)
...
DYNAMIC_DISCOVERY_PER_CATEGORY = _env_int("DYNAMIC_DISCOVERY_PER_CATEGORY", 4)
DYNAMIC_DISCOVERY_MAX_RESULTS_PER_QUERY = _env_int("DYNAMIC_DISCOVERY_MAX_RESULTS_PER_QUERY", 8)
DYNAMIC_DISCOVERY_MAX_QUERIES = _env_int("DYNAMIC_DISCOVERY_MAX_QUERIES", 6)
DYNAMIC_DISCOVERY_MAX_TOTAL_RESULTS = _env_int("DYNAMIC_DISCOVERY_MAX_TOTAL_RESULTS", 24)
DYNAMIC_DISCOVERY_SEARCH_DEPTH = _env("DYNAMIC_DISCOVERY_SEARCH_DEPTH", "basic")
